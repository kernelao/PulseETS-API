 ...
 */
final class Version20250410200354 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        //$this->addSql('ALTER TABLE reglages ALTER COLUMN user_nb_id INT NOT NULL');
        ...
        //$this->addSql('ALTER TABLE [user] DROP COLUMN theme_name');
                // Supprime l'index unique existant sur user_nb_id
                //$this->addSql('DROP INDEX UNIQ_46E7DCFACDE6C3 ON reglages');

                // Rend la colonne non nullable
                $this->addSql('ALTER TABLE reglages ALTER COLUMN user_nb_id INT NOT NULL');
        
                // Recrée l’index unique après modification
                $this->addSql('CREATE UNIQUE INDEX UNIQ_46E7DCFACDE6C3 ON reglages (user_nb_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reglages ALTER COLUMN user_nb_id INT');
